...
import { CreatePosition } from '@invariant-labs/sdk/lib/market'
...
describe('Position Slippage', () => {
  ...
  it('below range', async () => {
    ...
    const initPositionVars: CreatePosition = {
      ...
      upperTick,
      liquidityDelta: toDecimal(1, 0),
      knownPrice: toPrice(103, 2),
      slippage: toDecimal(3, 2)
    }
    await assertThrowsAsync(market.createPosition(initPositionVars, owner))
  })
