...
describe('whole-liquidity', () => {
  ...
  it('#init-positions()', async () => {
    ...
    await market.createPosition(initPositionVars, positionOwner1)

    const initPositionVars2: CreatePosition = {
      lowerTick: tick3,
      upperTick: tick1,
      liquidityDelta: new BN(3e5),
      pair,
      userTokenX: positionOwner1AccountX,
      userTokenY: positionOwner1AccountY,
      owner: positionOwner1.publicKey,
    ...
    await market.createPosition(initPositionVars2, positionOwner1)

    const initPositionVars3: CreatePosition = {
      lowerTick: tick3,
      upperTick: tick2,
      liquidityDelta: new BN(7e8),
      pair,
    ...
    await market.createPosition(initPositionVars3, positionOwner2)
