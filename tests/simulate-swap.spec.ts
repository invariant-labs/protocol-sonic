...
describe('swap', () => {
  ...
  it.skip('#swap', async () => {
    ...
    assert.ok(poolData.feeGrowthGlobalX.eq(new BN('8000000000000000000'))) // 0.6 % of amount - protocol fee
    assert.ok(poolData.feeGrowthGlobalY.eq(new BN('1000000000000000000')))
