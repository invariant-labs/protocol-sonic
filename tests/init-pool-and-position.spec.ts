...
import { CreateFeeTier, FeeTier, CreatePoolAndPosition } from '@invariant-labs/sdk/lib/market'
...
describe('swap', () => {
  ...
  it('#init Pool and position in a single tx', async () => {
    ...
    const props: CreatePoolAndPosition = {
      pair,
