...
describe('Staker math tests', () => {
  describe('Reward tests', () => {
    it('case 1', async () => {
      const data: CalculateReward = {
        ...
        secondsPerLiquidityInsideInitial: { v: new BN(4_000_000).mul(new BN(10 ** 12)) },
        secondsPerLiquidityInside: { v: new BN(10_000_000).mul(new BN(10 ** 12)) },
    ...
    it('case 2', async () => {
      const data: CalculateReward = {
        ...
        secondsPerLiquidityInsideInitial: { v: new BN(10_000_000).mul(new BN(10 ** 12)) },
        secondsPerLiquidityInside: { v: new BN(35_000_000).mul(new BN(10 ** 12)) },
    ...
    it('case 3', async () => {
      const data: CalculateReward = {
        ...
        secondsPerLiquidityInsideInitial: {
          v: new BN(0).mul(new BN(10).pow(new BN(12))).mul(new BN(10 ** 12))
        },
        secondsPerLiquidityInside: {
          v: new BN(2).mul(new BN(10).pow(new BN(12))).mul(new BN(10 ** 12))
        },
    ...
    it('case 4', async () => {
      const data: CalculateReward = {
        ...
        secondsPerLiquidityInsideInitial: { v: new BN(0).mul(new BN(10).pow(new BN(24))) },
        secondsPerLiquidityInside: { v: new BN(1).mul(new BN(10).pow(new BN(24))) },
    ...
    it('case 6', async () => {
      const data: CalculateReward = {
        ...
        secondsPerLiquidityInsideInitial: { v: new BN(0).mul(new BN(10).pow(new BN(24))) },
        secondsPerLiquidityInside: { v: new BN(2).mul(new BN(10).pow(new BN(24))) },
        currentTime: new BN(120)
      }
      const result = calculateReward(data)
    ...
    it('case 8', async () => {
      const data: CalculateReward = {
        ...
        endTime: new BN(200),
        liquidity: { v: new BN(5).mul(new BN(10).pow(new BN(6))) },
        secondsPerLiquidityInsideInitial: { v: new BN(2).mul(new BN(10).pow(new BN(24))) },
        secondsPerLiquidityInside: { v: new BN(2).mul(new BN(10).pow(new BN(24))) },
        currentTime: new BN(120)
      }
      const result = calculateReward(data)
    ...
    it('case 12', async () => {
      const data: CalculateReward = {
        ...
        startTime: new BN(1637002223),
        endTime: new BN(1640002223),
        liquidity: { v: new BN(1_000_000).mul(new BN(10).pow(new BN(6))).mul(new BN(10 ** 12)) },
  ...
  describe('SecondsPerLiquidityInside tests', () => {
    ...
    it('case 2', async () => {
      ...
      const result = calculateSecondsPerLiquidityInside(data)
      assert.ok(result.eq(new BN('99999999999994957300000')))
    })
    it('case 3', async () => {
